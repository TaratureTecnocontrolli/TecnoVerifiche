...
import EditTemperatureLogForm from "@/components/EditTemperatureLogForm";
...
export default async function EditTemperatureLogPage({ params }: PageProps) {
  ...
  if (
    record.verification_module !== "TEMPERATURE" &&
    record.mode !== "temperatura"
  ) {
    notFound();
  }
