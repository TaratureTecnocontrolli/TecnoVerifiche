...
import EditTorqueMeasurementsForm from "@/components/EditTorqueMeasurementsForm";
...
export default async function EditTorqueMeasurementsPage({ params }: PageProps) {
  ...
  if (
    record.verification_module !== "TORQUE" &&
    record.mode !== "dinamometria"
  ) {
    notFound();
  }
        ...
        <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-bold text-slate-950">
              Misure chiavi dinamometriche
            </h1>

            <p className="mt-2 max-w-3xl text-slate-600">
              Inserisci i punti di coppia, le tre letture ripetute e controlla
