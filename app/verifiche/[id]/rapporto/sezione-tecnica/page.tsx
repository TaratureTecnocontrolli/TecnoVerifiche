            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[1080px] text-sm">
                <thead className="bg-slate-50 text-left text-xs uppercase tracking-wide text-slate-500">
                  <tr>
                    <th className="px-4 py-3">Punto di verifica</th>
                    ...
                    <th className="px-4 py-3">Lettura massima</th>
                    <th className="px-4 py-3">Lettura minima</th>
                    <th className="px-4 py-3">Media letture</th>
