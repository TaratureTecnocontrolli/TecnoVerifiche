...
import EditDimensionalMeasurementsForm from "@/components/EditDimensionalMeasurementsForm";
...
export default async function EditDimensionalMeasurementsPage({
  params,
}: PageProps) {
  ...
  if (
    record.verification_module !== "DIMENSIONAL" &&
    record.mode !== "dimensionale"
  ) {
    notFound();
  }
  ...
  return (
    <AppShell>
      <div className="space-y-6">
        <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-slate-600">
              Inserisci i punti di verifica, i tre scostamenti ripetuti e
              controlla errore, ripetibilità e incertezza strumentale.
            </p>
          </div>
        ...
        <EditDimensionalMeasurementsForm
          recordId={id}
