...
import EditMassMeasurementsForm from "@/components/EditMassMeasurementsForm";
...
export default async function EditMassMeasurementsPage({ params }: PageProps) {
  ...
  if (record.verification_module !== "MASS" && record.mode !== "massa") {
    notFound();
  }
        ...
        <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-bold text-slate-950">
              Misure massa / bilance
            </h1>

            <p className="mt-2 max-w-3xl text-slate-600">
              Inserisci le tre prove (ripetibilità, eccentricità, linearità) e
              controlla errore e ripetibilità.
            </p>
          </div>
