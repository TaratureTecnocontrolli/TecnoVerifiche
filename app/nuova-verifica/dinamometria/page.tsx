      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-slate-600">
            Crea una nuova verifica in bozza per strumenti di coppia. In questo
            primo passaggio vengono salvati cliente, strumento in prova,
            strumento campione e snapshot tecnico.
          </p>
        </div>
