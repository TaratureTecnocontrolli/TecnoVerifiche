...
import SclerometricVerificationStarter from "@/components/SclerometricVerificationStarter";
...
function scopeDescription(scope: VerificationScope) {
  if (scope === "VI") {
    return "Flusso per verifica interna di sclerometri e strumenti a rimbalzo, con inserimento immediato delle letture e rapportino tecnico finale.";
  }
  return "Flusso per verifica/taratura di sclerometri del cliente, con inserimento immediato delle letture e rapporto finale.";
}

export default async function NewSclerometricVerificationPage({
  searchParams,
}: PageProps) {
    ...
    <AppShell>
      <div className="space-y-6">
        <NewVerificationHeader
          title="Nuova verifica sclerometrica"
          description={scopeDescription(verificationScope)}
          verificationScope={verificationScope}
          basePath="/nuova-verifica/sclerometro"
          showScopeSwitch
        />
        ...
        <SclerometricVerificationStarter
          verificationScope={verificationScope}
          customers={customers}
