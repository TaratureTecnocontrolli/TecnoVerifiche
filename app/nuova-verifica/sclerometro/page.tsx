      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-slate-600">
            Crea una nuova verifica in bozza per sclerometri e strumenti di
            prova non distruttiva a rimbalzo. In questo primo passaggio
            vengono salvati cliente, strumento in prova, incudine di
            riferimento e snapshot tecnico.
          </p>
        </div>
