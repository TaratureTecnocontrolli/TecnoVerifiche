      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-slate-600">
            Crea una nuova verifica in bozza per bilance e strumenti di misura
            della massa. In questo primo passaggio vengono salvati cliente,
            strumento in prova, massa campione e snapshot tecnico. Le tre
            prove (ripetibilità, eccentricità, linearità) si compilano nel
