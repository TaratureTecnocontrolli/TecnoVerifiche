...
function scopeDescription(scope: VerificationScope) {
  if (scope === "VI") {
    return "Flusso per verifica interna di bilance e strumenti di misura della massa, con inserimento immediato delle tre prove e rapportino tecnico finale.";
  }

  return "Flusso per verifica/taratura di bilance e strumenti di misura della massa del cliente, con inserimento immediato delle tre prove e rapporto finale.";
}

export default async function NewMassVerificationPage({
  searchParams,
}: PageProps) {
