      ...
      <div className="space-y-6">
        <div>
          ...
          <h1 className="mt-3 text-3xl font-bold text-slate-950">
            Nuova verifica dimensionale
          </h1>

          <p className="mt-2 max-w-3xl text-slate-600">
            Crea una nuova verifica in bozza per calibri, setacci o sfere
            campione. Scegli il tipo di controllo: calibri (esterni +
            interni) oppure setacci/sfere (interno asse X + asse Y).
          </p>
        </div>
