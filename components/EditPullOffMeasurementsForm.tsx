...
export default function EditPullOffMeasurementsForm({
  ...
  function validate() {
    ...
    if (!scale.referenceInstrumentId) {
      throw new Error("Seleziona la cella di carico campione usata.");
    }

    if (!selectedReferenceInstrument) {
      throw new Error("Cella di carico campione usata non trovata.");
    }

    if (hasBlockedReferenceInstrument) {
      throw new Error(
        "La cella di carico campione usata è scaduta o fuori servizio."
      );
    }
  ...
  async function ensureScaleExists() {
    ...
    if (!selectedReferenceInstrument) {
      throw new Error("Cella di carico campione usata non selezionata.");
    }
          ...
          <div className="border-b border-slate-200 p-5">
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <label className="space-y-1 lg:col-span-2">
                <span className="text-sm font-medium text-slate-700">
                  Cella di carico campione usata *
                </span>
                <select
                ...
                >
                  <option value="">Seleziona cella di carico campione</option>
              ...
              >
                ...
                {hasBlockedReferenceInstrument && (
                  <p className="mt-3 font-medium">
                    Blocco: la cella di carico campione è scaduta o fuori servizio.
                  </p>
                )}
              </div>
            )}
